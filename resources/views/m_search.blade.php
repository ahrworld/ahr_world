...
<body data-ng-app="app" id="app" data-custom-background data-off-canvas-nav>
        ...
        <main style="margin-top:80px;">
        	<div class="container search_bar" style="margin:10px auto; text-align:center;">
        		 <input style="width:400px; display: inline;" type="text" name="name" class="form-control " placeholder="職種から選ぶ">
        		 <input style="width:200px; display: inline;" type="text" name="name" class="form-control " placeholder="経験・スキル">
        		 <input style="width:200px; display: inline;" type="text" name="name" class="form-control " placeholder="言語">
        		 <input style="width:200px; display: inline;" type="text" name="name" class="form-control " placeholder="勤務地">
        		 <button class="ahr-button">檢&nbsp;&nbsp;&nbsp;索</button>
        	</div>
	        <div class="container">
	          	  
	          	  <div style="float:right; margin-top:10px; margin-right:15px;"> 
	          	  	<button class="btn btn-default" style="padding:15px;"></button>
	          	  	<button class="btn btn-default" style="padding:15px;"></button>
	          	  	<button class="btn btn-default" style="padding:15px;"></button>
	          	  </div>
	          	  <!-- お気に入り企業 Tab panes -->
	          	    ...
	          	    <div  class="ahr-panel ">
	          	    	<div class="">
	          	    		<button class="btn btn-default ahr-button_5 active">企業検索</button>
	          	    		<button class="btn btn-default ahr-button_5">検索履歴</button>
	          	    	</div>
	          	    	<div class="wrapper">
	          	    	    <!-- 1 -->
	          	    	    <style>
