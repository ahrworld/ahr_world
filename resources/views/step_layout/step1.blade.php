<div class="tab-pane" id="tab1">
  <div>
    <label style="margin-right:7px;" class="ahr-label-default">STEP1</label>
  </div>
  <div>
    <p style="font-size:12px; color:#0094E5;">
    	<span style="color:red;">※必須項目です</span><br>氏名と生年月日を入力してください。
    </p>
  </div>
  <!-- content -->
		...
		<div class="row">
			...
			<div class="col-md-6">
			  <div class="form-group">
			    ...
			    <input type="text" name="family_name_en" class="form-control">
			  </div>
		    </div>
			<div class="col-md-6">
			  <div class="form-group">
			    <label for="exampleInputName">Surname</label>
			    <input type="text"  name="surname_en" class="form-control">
			  </div>
			</div>
		    ...
		    <div class="col-md-12">
			  <div class="form-group">
			     <label for="exampleInputName">生年月日</label>
