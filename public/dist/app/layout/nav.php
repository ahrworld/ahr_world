<div id="nav-wrapper">
    <ul id="nav"
        ...
        <li>
            ...
            <ul>
                 <li><a href="#/table/personnels"><i class="fa fa-caret-right"></i><span data-i18n="応募者管理"></span></a></li>
                 <li><a href="#/table/business"><i class="fa fa-caret-right"></i><span data-i18n="企業管理"></span></a></li>
         ...
         <li>
            <a href="#/mail"><i class="fa fa-envelope-o"><span class="icon-bg bg-primary"></span></i><span data-i18n="メール管理">></span></a>
            <ul>
                <li><a href="#/mail/contact"><i class="fa fa-caret-right"></i><span data-i18n="お問い合わせ"></span></a></li>
            </ul>
        </li>
    </ul>
</div>