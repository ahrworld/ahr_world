    ...
    <ul id="nav"
        ...
        <li>
         ...
         <li>
            ...
            <ul>
                <li><a href="#/mail/inbox"><i class="fa fa-caret-right"></i><span data-i18n="求職者と企業メール"></span></a></li>
                <li><a href="#/mail/inbox"><i class="fa fa-caret-right"></i><span data-i18n="お問い合わせ"></span></a></li>
            </ul>
        </li>
    </ul>
</div>