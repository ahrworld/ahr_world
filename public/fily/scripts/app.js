    ...
    angular.module('app')
        .config(['$routeProvider', function($routeProvider) {
            ...
            setRoutes = function(route) {
                ...
                url = '/' + route;
                config = {
                    templateUrl: 'fily/app/' + route + '.php'
                };
            ...
            $routeProvider
                ...
                .when('/dashboard', {templateUrl: 'fily/app/dashboard/dashboard.php'})
                .when('/404', {templateUrl: 'app/page/404.php'})
    ...
    '$http', '$rootScope', '$window', function($http, $rootScope, $window) {
      ...
      localize = {
        ...
        buildUrl: function() {
          ...
          return 'fily/i18n/resources-locale_' + localize.language + '.js';
        },
